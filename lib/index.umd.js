(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Zod = {}, global.camelCase));
    ...
    function processCreateParams(params) {
        if (!params)
            return {};
        const { errorMap, invalid_type_error, required_error, description, symbol, name, } = params;
    ...
    class ZodType {
        ...
        get symbol() {
            return camelCase__default["default"](this._def.symbol ? this._def.symbol : this._def.name);
        }
        get name() {
