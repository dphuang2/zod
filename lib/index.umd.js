(function (global, factory) {
    ...
    function processCreateParams(params) {
        if (!params)
            return {};
        const { errorMap, invalid_type_error, required_error, description, name, canBeProportioned, } = params;
    ...
    class ZodType {
        ...
        get canBeProportioned() {
            ...
            if (this instanceof ZodEffects)
                return this._def.schema.canBeProportioned;
            if (this instanceof ZodUnion)
                return this._def.options[0].canBeProportioned;
        ...
        get name() {
            ...
            if (this instanceof ZodNullable)
                return this._def.innerType.name;
            if (this instanceof ZodEffects)
                return this._def.schema.name;
            if (this instanceof ZodUnion)
                return this._def.options[0].name;
            if (!this._def.name) {
        ...
        get isObject() {
            if (this instanceof ZodOptional)
                return this._def.innerType.isObject;
            if (this instanceof ZodNullable)
                return this._def.innerType.isObject;
            if (this instanceof ZodEffects)
                return this._def.schema.isObject;
            return this instanceof ZodObject;
        }
        get isArray() {
            if (this instanceof ZodOptional)
                return this._def.innerType.isArray;
            if (this instanceof ZodNullable)
                return this._def.innerType.isArray;
            if (this instanceof ZodEffects)
                return this._def.schema.isArray;
            return this instanceof ZodArray;
        }
        get isUnion() {
            if (this instanceof ZodOptional)
                return this._def.innerType.isUnion;
            if (this instanceof ZodNullable)
                return this._def.innerType.isUnion;
        ...
        get isString() {
            if (this instanceof ZodOptional)
                return this._def.innerType.isString;
            if (this instanceof ZodNullable)
                return this._def.innerType.isString;
            if (this instanceof ZodEffects)
                return this._def.schema.isString;
            if (this instanceof ZodUnion)
                return this._def.options[0].isString;
            return this instanceof ZodString || this instanceof ZodLiteral;
        }
        get isNumber() {
            if (this instanceof ZodOptional)
                return this._def.innerType.isNumber;
            if (this instanceof ZodNullable)
                return this._def.innerType.isNumber;
            if (this instanceof ZodEffects)
                return this._def.schema.isNumber;
            if (this instanceof ZodUnion)
                return this._def.options[0].isNumber;
            return this instanceof ZodNumber;
        }
        get isBoolean() {
            if (this instanceof ZodOptional)
                return this._def.innerType.isBoolean;
            if (this instanceof ZodNullable)
                return this._def.innerType.isBoolean;
            if (this instanceof ZodEffects)
                return this._def.schema.isBoolean;
            if (this instanceof ZodUnion)
                return this._def.options[0].isBoolean;
            return this instanceof ZodBoolean;
        }
        get isDate() {
            if (this instanceof ZodOptional)
                return this._def.innerType.isDate;
            if (this instanceof ZodNullable)
                return this._def.innerType.isDate;
            if (this instanceof ZodEffects)
                return this._def.schema.isDate;
            if (this instanceof ZodUnion)
                return this._def.options[0].isDate;
